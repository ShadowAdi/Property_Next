...
const PropertyEditForm = () => {
  ...
  const handlerAmenitiesChange = (e) => {
    ...
    <form onSubmit={handleEditSubmit}>
      ...
      <div className="mb-4">
        ...
        <textarea
          ...
          className="border rounded w-full py-2 px-3"
          rows="4"
          placeholder="Update an optional description of your property"
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
          <div>
            <input
              ...
              onChange={handlerAmenitiesChange}
            />
      ...
      <div>
        <button
         ...
         focus:outline-none focus:shadow-outline"
          type="submit"
        >
          <i className="fas fa-plus-circle mr-2"></i> Update Property
        </button>
      </div>
    </form>
  );
